...
| [prompt_versioning/](./prompt_versioning/) | Version prompts in the Opik Prompt Library, compare versions for hallucination with side-by-side experiments, and run traced inference via LiteLLM |
