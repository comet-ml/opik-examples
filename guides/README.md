...
| [gpu_capacity_planning/](./gpu_capacity_planning/) | MCP-driven GPU capacity planning — pull Comet EM system metrics via the Comet MCP server, flag under-utilized hardware, generate LLM rightsizing recommendations, trace it all in Opik |
