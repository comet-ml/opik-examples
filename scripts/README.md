...
Standalone utility scripts for automating and managing Opik resources programmatically.

| Script | Description |
|---|---|
| [trace_management/](./trace_management/) | Inspect and delete traces by date range, tags, or per-tag TTL policies |
