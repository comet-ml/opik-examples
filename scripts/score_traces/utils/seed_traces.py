...
SEED_TRACES = [
    ...
    {"input": {"question": "What is 2+2?", "expected": "4"},
     "output": {"answer": "5", "context": ["basic arithmetic"]}},          # wrong answer
    {"input": {"question": "Capital of Japan?", "expected": "Tokyo"},
     "output": {"answer": "Kyoto", "context": ["Tokyo is the capital of Japan"]}},  # contradicts context
    {"input": {"question": "Speed of light?", "expected": "299792458 m/s"},
     "output": {"answer": "It was a sunny day.", "context": ["physics constants"]}},  # off-topic
    {"input": {"question": "Chemical symbol for gold?", "expected": "Au"},
     "output": {"answer": "Gd", "context": ["Gold's symbol is Au"]}},       # wrong, contradicts context
...
def main() -> None:
    ...
    if dry_run:
        print(f"DRY_RUN: would seed {len(SEED_TRACES)} traces into project '{PROJECT_NAME}'. "
